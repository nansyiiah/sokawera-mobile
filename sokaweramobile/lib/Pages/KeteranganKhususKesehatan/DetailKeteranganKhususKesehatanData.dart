...
class DetailKeteranganKhususKesehatanData extends StatefulWidget {
  final String judul;
  final String keyy;
  const DetailKeteranganKhususKesehatanData(
      {super.key, required this.judul, required this.keyy});

  @override
  State<DetailKeteranganKhususKesehatanData> createState() =>
      _DetailKeteranganKhususKesehatanDataState();
}

class _DetailKeteranganKhususKesehatanDataState
    extends State<DetailKeteranganKhususKesehatanData> {
  List datas = [];
