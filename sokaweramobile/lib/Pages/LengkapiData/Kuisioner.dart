...
class KuisionerLengkapi extends StatefulWidget {
  final String nik;
  const KuisionerLengkapi({super.key, required this.nik});

  @override
  State<KuisionerLengkapi> createState() => _KuisionerLengkapiState();
}

class _KuisionerLengkapiState extends State<KuisionerLengkapi> {
