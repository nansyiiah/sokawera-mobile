...
class DetailKeteranganKhususPendidikanData extends StatefulWidget {
  final String judul;
  final String keyy;
  const DetailKeteranganKhususPendidikanData(
      {super.key, required this.judul, required this.keyy});

  @override
  State<DetailKeteranganKhususPendidikanData> createState() =>
      _DetailKeteranganKhususPendidikanDataState();
}

class _DetailKeteranganKhususPendidikanDataState
    extends State<DetailKeteranganKhususPendidikanData> {
  List datas = [];
