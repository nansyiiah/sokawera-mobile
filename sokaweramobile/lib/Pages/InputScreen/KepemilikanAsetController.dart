...
class KepemilikanAsetController extends StatefulWidget {
  const KepemilikanAsetController({super.key});

  @override
  State<KepemilikanAsetController> createState() =>
      _KepemilikanAsetControllerState();
}

class _KepemilikanAsetControllerState extends State<KepemilikanAsetController> {
  var nik_kk;
  ...
  _savedDataToLocal() async {
    ...
    SharedPreferences localStorage = await SharedPreferences.getInstance();
    localStorage.setString("kepemilikan_aset", userEncode);
