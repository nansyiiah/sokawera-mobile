...
class KeteranganPerumahanController extends StatefulWidget {
  const KeteranganPerumahanController({super.key});

  @override
  State<KeteranganPerumahanController> createState() =>
      _KeteranganPerumahanControllerState();
}

class _KeteranganPerumahanControllerState
    extends State<KeteranganPerumahanController> {
  var nik_kk;
  ...
  _savedDataToLocal() async {
    ...
    SharedPreferences localStorage = await SharedPreferences.getInstance();
    localStorage.setString("keterangan_perumahan", userEncode);
