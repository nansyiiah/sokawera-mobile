...
class DetailKejadianKelahiranData extends StatefulWidget {
  final String judul;
  final String keyy;
  const DetailKejadianKelahiranData(
      {super.key, required this.judul, required this.keyy});

  @override
  State<DetailKejadianKelahiranData> createState() =>
      _DetailKejadianKelahiranDataState();
}

class _DetailKejadianKelahiranDataState
    extends State<DetailKejadianKelahiranData> {
  List datas = [];
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text(
                                            "${datas[0][widget.keyy][index]["nama_bayi"]}"),
                                      ),
                                    ],
                                  ),
                                ),
